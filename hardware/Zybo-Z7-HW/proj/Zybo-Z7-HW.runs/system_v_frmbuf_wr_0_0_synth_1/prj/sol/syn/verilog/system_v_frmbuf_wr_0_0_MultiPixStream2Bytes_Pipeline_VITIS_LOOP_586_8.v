...
module system_v_frmbuf_wr_0_0_MultiPixStream2Bytes_Pipeline_VITIS_LOOP_586_8 (
        ...
        img_empty_n,
        img_read,
        p_0_1_0_0_0_7145_lcssa160,
        p_0_0_0_0_0_7136_lcssa157,
        trunc_ln571_1,
        ...
        sub209_cast58,
        cmp212,
        p_0_1_0_0_0_7144_out,
        p_0_1_0_0_0_7144_out_ap_vld,
        p_0_0_0_0_0_7135_out,
        p_0_0_0_0_0_7135_out_ap_vld
);
...
input   img_empty_n;
output   img_read;
input  [7:0] p_0_1_0_0_0_7145_lcssa160;
input  [7:0] p_0_0_0_0_0_7136_lcssa157;
...
input  [0:0] cmp212_2;
input  [0:0] cmp212_1;
input  [12:0] sub209_cast58;
input  [0:0] cmp212;
output  [7:0] p_0_1_0_0_0_7144_out;
output   p_0_1_0_0_0_7144_out_ap_vld;
output  [7:0] p_0_0_0_0_0_7135_out;
output   p_0_0_0_0_0_7135_out_ap_vld;

reg ap_idle;
reg img_read;
reg bytePlanes_plane12_write;
reg bytePlanes_plane01_write;
reg p_0_1_0_0_0_7144_out_ap_vld;
reg p_0_0_0_0_0_7135_out_ap_vld;
...
wire   [7:0] trunc_ln145_fu_454_p1;
wire   [0:0] or_ln590_1_fu_458_p2;
wire   [7:0] trunc_ln145_1_fu_468_p1;
wire   [0:0] or_ln590_2_fu_472_p2;
wire   [7:0] trunc_ln145_2_fu_476_p1;
wire   [0:0] or_ln590_3_fu_480_p2;
wire   [7:0] trunc_ln145_4_fu_484_p1;
wire   [0:0] or_ln590_4_fu_488_p2;
wire   [0:0] or_ln590_5_fu_492_p2;
wire   [0:0] or_ln590_6_fu_496_p2;
wire   [0:0] or_ln590_7_fu_500_p2;
wire   [7:0] trunc_ln145_7_fu_504_p1;
wire   [7:0] trunc_ln145_9_fu_508_p1;
wire   [7:0] trunc_ln145_11_fu_512_p1;
reg    ap_block_pp0_stage7_11001;
wire   [7:0] trunc_ln145_13_fu_516_p1;
...
wire  signed [13:0] sub209_cast58_cast_fu_399_p1;
reg    ap_done_reg;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (brmerge79 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (brmerge79 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (icmp_ln586_reg_644 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        p_0_0_0_0_0_7135_out_ap_vld = 1'b1;
    end else begin
        p_0_0_0_0_0_7135_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (icmp_ln586_reg_644 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
        p_0_1_0_0_0_7144_out_ap_vld = 1'b1;
    end else begin
        p_0_1_0_0_0_7144_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage1_01001 = (((img_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_predicate_op48_read_state2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((bytePlanes_plane01_full_n == 1'b0) | ((bytePlanes_plane12_full_n == 1'b0) & (brmerge79 == 1'd1)))));
end

always @ (*) begin
    ap_block_pp0_stage1_11001 = (((img_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_predicate_op48_read_state2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((bytePlanes_plane01_full_n == 1'b0) | ((bytePlanes_plane12_full_n == 1'b0) & (brmerge79 == 1'd1)))));
end

always @ (*) begin
    ap_block_pp0_stage1_subdone = (((img_empty_n == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_predicate_op48_read_state2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((bytePlanes_plane01_full_n == 1'b0) | ((bytePlanes_plane12_full_n == 1'b0) & (brmerge79 == 1'd1)))));
end
...
always @ (*) begin
    ap_block_state10_pp0_stage1_iter1 = ((bytePlanes_plane01_full_n == 1'b0) | ((bytePlanes_plane12_full_n == 1'b0) & (brmerge79 == 1'd1)));
end
...
assign cmp210_fu_437_p2 = (($signed(zext_ln586_fu_433_p1) < $signed(sub209_cast58_cast_fu_399_p1)) ? 1'b1 : 1'b0);

assign icmp_ln586_fu_421_p2 = ((ap_sig_allocacmp_x_1 == trunc_ln571_1) ? 1'b1 : 1'b0);
...
assign p_0_0_0_0_0_7135_out = in_pix_Y_V_8_fu_94;

assign p_0_1_0_0_0_7144_out = in_pix_UV_V_8_fu_98;

assign sub209_cast58_cast_fu_399_p1 = $signed(sub209_cast58);

assign trunc_ln145_11_fu_512_p1 = img_dout[7:0];

assign trunc_ln145_13_fu_516_p1 = img_dout[7:0];

assign trunc_ln145_1_fu_468_p1 = img_dout[7:0];

assign trunc_ln145_2_fu_476_p1 = img_dout[7:0];

assign trunc_ln145_4_fu_484_p1 = img_dout[7:0];

assign trunc_ln145_7_fu_504_p1 = img_dout[7:0];

assign trunc_ln145_9_fu_508_p1 = img_dout[7:0];

assign trunc_ln145_fu_454_p1 = img_dout[7:0];

assign x_2_fu_427_p2 = (ap_sig_allocacmp_x_1 + 13'd1);

assign zext_ln586_fu_433_p1 = ap_sig_allocacmp_x_1;
