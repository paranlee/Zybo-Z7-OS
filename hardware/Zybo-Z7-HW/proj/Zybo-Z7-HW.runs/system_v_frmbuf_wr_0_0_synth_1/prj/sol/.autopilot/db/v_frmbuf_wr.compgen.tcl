...
set ID 160
set hasByteEnable 0
set MemName system_v_frmbuf_wr_0_0_BYTES_PER_PIXEL_ROM_AUTO_1R
...
set ID 161
set hasByteEnable 0
set MemName system_v_frmbuf_wr_0_0_MEMORY2LIVE_ROM_AUTO_1R
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 3
set AddrRange 44
...
set name system_v_frmbuf_wr_0_0_mm_video_m_axi
if {${::AESL::PGuard_rtl_comp_handler}} {
